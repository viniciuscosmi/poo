...
//        if (isIsosceles(l1, l2, l3)){
        //           Triangle a = new IsoscelesTriangule(l1,l2,l3);
        //    return a.getArea();
        // }
        //if (isEquilateral(l1,l2,l3)){
        //   Triangle a = new EquilateralTriangule(l1,l2,l3);
        //   return a.getArea();
        // }
        //if (isScalene(l1,l2,l3)){
        //   Triangle a = new ScaleneTriangule(l1,l2,l3);
        //   return a.getArea();
        //}
	    return getTriangule(l1,l2,l3).getArea();
    }
}